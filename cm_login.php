...
<h1>
<p div="" align="center">Вход в Панель управления контент-менеджера RDSmedia</p>
</h1>
<?php
session_start();
if($_SESSION['logged']) {
header('Location: /cm_panel.php?type=1');
}
...
if($_GET['error']==1) echo "Ошибка! Введенный e-mail отсутствует в базе данных пользователей"?>
   <form action="action.php" method="post" align="center">
    ...
    <p><button formaction="cm_loged.php">OK</button>
   </form>
<a href="google_login.php?mode=1" target="" title = "login with Google" align="center"><Img src= "http://todocamp.com/media/i/google-login-button.png"></a>
  </td>
